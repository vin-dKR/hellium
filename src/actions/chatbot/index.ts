          ...
          messages: [
            {
              ...
              The array of questions : [${chatBotDomain.filterQuestions
                .map((questions: {question: string}) => questions.question)
                .join(', ')}]

              if the customer says something out of context or inapporpriate. Simply say this is beyond you and you will get a real user to continue the conversation. And add a keyword (realtime) at the end.

              if the customer agrees to book an appointment send them this link https://hellium.vercel.app/portal/${id}/appointment/${
                checkCustomer?.customer[0].id
              }

              if the customer wants to buy a product redirect them to the payment page https://hellium.vercel.app/portal/${id}/payment/${
                checkCustomer?.customer[0].id
              }
          `,
            },
