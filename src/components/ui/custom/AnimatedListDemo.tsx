    ...
    return (
        <figure
            className={cn(
                ...
                // animation styles
                "transition-all duration-200 ease-in-out hover:rounded-lg",
                // light styles
...
export function AnimatedListDemo({
    ...
    return (
        <div
            className={cn(
                "relative flex h-[450px] w-full flex-col p-8 overflow-hidden rounded-lg",
                // light styles
                "bg-transparent [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] ",
                // dark styles
                "dark:bg-background dark:backdrop-blur-md dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]",
                className,
            )}
        >
            <AnimatedList>
